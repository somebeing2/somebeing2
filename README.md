...
What I've built
 ...
 Aurora  Prototype multi-agent platform (CrewAI + RAG) for IT-governance and regulatory risk review over policy circulars. **[Architect-WASM-IDE](https://github.com/somebeing2/architect-ide)**  Browser-native data science IDE: Python, R & SQL running entirely in-browser via WebAssembly, with zero-copy Apache Arrow data transfer. [Live demo](https://somebeing2.github.io/architect-ide/).
